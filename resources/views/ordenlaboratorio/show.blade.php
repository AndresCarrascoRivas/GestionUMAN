        ...
        <div class="card shadow-sm">
            <div class="card-body">
                <dl class="row">
                    @php
                        $info = [
                            'UMAN Serial' => $ordenlaboratorio->equipoUman->serial ?? $ordenlaboratorio->equipo_uman_serial,
                            ...
                            'Versión Raspberry' => $ordenlaboratorio->rpi_version,
                            'BAM' => $ordenlaboratorio->bam ? 'Sí' : 'No',
